...
class ResidualModelImpedanceForceTpl
 ...
 public:
  ...
  typedef ResidualDataImpedanceForceTpl<Scalar> Data;
...
template <typename _Scalar>
struct ResidualDataImpedanceForceTpl : public ResidualDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  ResidualDataImpedanceForceTpl(Model<Scalar>* const model,
                                DataCollectorAbstract* const data)
